...
class LedgersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ledger" do
    assert_difference('Ledger.count') do
      post ledgers_url, params: { ledger: { playlist_id: @ledger.playlist_id, plays: @ledger.plays, song_id: @ledger.song_id } }, as: :json
    end
  ...
  test "should update ledger" do
    patch ledger_url(@ledger), params: { ledger: { playlist_id: @ledger.playlist_id, plays: @ledger.plays, song_id: @ledger.song_id } }, as: :json
    assert_response 200
  end
